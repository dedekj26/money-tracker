                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="date" name="start_date" id="start_date" value="{{ old('start_date', $configuration->start_date->format('Y-m-d')) }}" 
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date', $configuration->end_date->format('Y-m-d')) }}" 
