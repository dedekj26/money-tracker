<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 mb-6">
                <h2 class="text-xl md:text-2xl font-bold text-gray-800">Edit Transaksi</h2>
                <p class="mt-2 text-gray-600">Perbarui detail transaksi keuangan Anda</p>
            </div>
                    ...
                    <form method="POST" action="{{ route('transactions.update', $transaction) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <input type="text" name="description" id="description" value="{{ old('description', $transaction->description) }}" class="mt-1 py-3 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm border-gray-300 rounded-md text-base" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="amount" id="amount" value="{{ old('amount', $transaction->amount) }}" min="1" class="mt-1 py-3 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm border-gray-300 rounded-md text-base" required>
                            </div>

                            <!-- Date -->
                            <div>
                                <label for="date" class="block text-sm font-medium text-gray-700">Tanggal Transaksi</label>
                                <input type="date" name="date" id="date" value="{{ old('date', $transaction->date) }}" class="mt-1 py-3 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm border-gray-300 rounded-md text-base" required>
                            </div>
                        </div>
