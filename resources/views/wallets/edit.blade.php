                ...
                <div class="px-6 py-5">
                    <form action="{{ route('wallets.update', $wallet) }}" method="POST">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-700">
                                        Perubahan saldo secara manual dapat mempengaruhi laporan keuangan Anda. Pastikan nilai yang dimasukkan sudah benar.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('wallets.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Batal
                            </a>
